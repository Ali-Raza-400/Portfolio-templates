            ...
            <div className="col-12 col-sm-6 col-md-6 col-lg-6 map-contact-form-col">
              <div className="formbold-main-wrapper">
                <div className="formbold-form-wrapper">
                  <form method="POST" className="salv-conatct-us dark-conatct-form">
                    ...
                    <div>
                      ...
                      <button className="salv-home-get-touch dark-salv-cont-get-touch salv-send-btn">
                        <span className="salv-get-text salv-get-text-btn">send message</span>
                      </button>
                    </div>
                  </form>
                </div>
