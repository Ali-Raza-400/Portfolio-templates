          ...
          <div className="container-fluid">
            <div className="row home-content-row">
              ...
              <div class="col-12 col-md-5 col-lg-4 col-xxl-5 salva-left-fixed-image slava-youtube-video p-0">
                ...
                <div class="salva-home-image dark-salva-home-image"></div>
                <iframe
                  src="https://www.youtube.com/embed/uWQ_8CtvzoY?controls=0&showinfo=0&rel=0&autoplay=1&loop=1&mute=1"
                  allowfullscreen
                ></iframe>
                <div class="salva-weekend-image dark-weekend-image"></div>
              </div>
                        ...
                        <div className="salv-tab-filters">
                          <ul className="salv-tab-menu clearfix">
                            ...
                            >
                              <a
                                href="#two"
                                className={`salv-tab-item dark-tab-item sm-font inter-font-600 ${
                                  activeTab === "two" ? "activ" : ""
                                }`}
                                onClick={(e) => {
                                  e.preventDefault(); // Prevent default anchor behavior
