...
const Home = () => {
  ...
  useEffect(() => {
    ...
    if (textWrapper) {
      const textContent = "Sergio Marquina";
        ...
        <section className="salva-fixed-content" id="home_page">
          <div className="container-fluid">
            <div className="row home-content-row">
              ...
              <div class="col-12 col-md-5 col-lg-4 col-xxl-5 salva-left-fixed-image slava-youtube-video p-0">
                <h1 class="d-none">this is a image of salva fixed</h1>
                <div class="salva-home-image"></div>
                <iframe
                  src="https://www.youtube.com/embed/uWQ_8CtvzoY?controls=0&showinfo=0&rel=0&autoplay=1&loop=1&mute=1"
                  allowfullscreen
                ></iframe>
              ...
              <div className="col-12 col-md-12 col-lg-8 col-xxl-7 salva-home-content p-0">
                ...
                >
                  <div className="salva-home-main-content">
                    <h2
                      className="mb-0 salv-home-title b-text lg-font inter-font-900 ml3"
                      ref={textWrapperRef}
                    >
                      Sergio Marquina
                    </h2>
                    <p className="mb-0 salv-home-desc b-text inter-font-500">
                    ...
                    <div className="salv-home-buttons">
                      <div className="salv-home-get-touch">
                        <Link to="/contact" target="_self">
                          <span className="salv-get-text">get in touch</span>
                        </Link>
                      </div>
                      <button
                        className="salv-down-cv-btn"
                ...
                <header className="salva-header salv-home-header">
                            ...
                            <ul id="menu" className="sal-menu-list">
                              <li className="salv-menu-item">
                                <Link
                                  to="/"
                                  target="_self"
                                  className="b-text salv-menu-link active"
                                >
                                  Home
                                </Link>
                              </li>
