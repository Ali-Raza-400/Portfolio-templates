  ...
  return (
    <>
      <div className="salv-inrto-content">
        <h4 className="salv-about-title salv-home-title md-font b-text inter-font-900 mb-0">
          Zorro
        </h4>
        <p className="salv-about-desc mb-0 second-color inter-font-400">
      ...
      <div className="salv-project-details">
        <div className="row salv-project-detat-row">
          ...
          <div className="col-12 col-md-6 col-sm-6 col-lg-6">
            <div className="salv-project-detail-col">
              <div className="salv-proje-field">
              ...
              <div className="salv-proje-field md-font-one inter-font-600">
              ...
              <div className="salv-live-preview">
        ...
        <div className="salv-proj-desc">
          <div className="row">
            <h3 className="mb-0 salv-about-proje b-text inter-font-600">
              About Project
            </h3>
            <div className="col-12 col-sm-6 col-md-6 col-lg-6">
              <p className="mb-0 project-desc second-color inter-font-400">
                There are many variations of passages of Lorem Ipsum available,
                but the majority have suffered alteration in some form, by
                injected humour, or randomised words which don't look even
                slightly believable.
              </p>
              <p className="mb-0 project-desc-two project-desc second-color inter-font-400">
            ...
            <div className="col-12 col-sm-6 col-md-6 col-lg-6">
              <p className="mb-0 project-desc projec-desc-three second-color inter-font-400">
                There are many variations of passages of Lorem Ipsum available,
                but the majority have suffered alteration in some form, by
                injected humour, or randomised words which don't look even
                slightly believable.
