          ...
          <div className="salv-testi-testimonial-wrap testimonial position-relative">
            <OwlCarousel
              ...
              responsive={{
                ...
                324: {
                  items: 1, // Display two items on screens 324px wide and above
                },
              }}
            >
              {/* <!-- Testimonial Block --> */}
                ...
                <div className="salv-inner-box">
                  ...
                  <div className="salv-info-box">
                    ...
                    <div className="salv-user-details">
                      <h4 className="name">Jeniffer Lopez</h4>
                      <span className="designation">CEO, Molina</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="salv-testimonial-block">
                <div className="salv-inner-box">
                  ...
                  <div className="salv-info-box">
                    ...
                    <div className="salv-user-details">
                      <h4 className="name">Benny Dayal</h4>
